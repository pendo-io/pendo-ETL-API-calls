...
This POST request body will generate a response that generates detailed event data for a visitor by account.  The number of events and minutes spent are summed by day.
